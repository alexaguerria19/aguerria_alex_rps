...
text.hideturtle()
text.penup()
# sets the positions of the images on the screen
show_rock(-300, 0)
show_paper(0, 0)
show_scissors(300, 0)
...
# tells the computer to pull from the random choices when clicked
def comprandchoose():
    compchose = ""
...
# sets the positions of the images when you click an image
compchose = ""
def mouse_pos(x, y):
